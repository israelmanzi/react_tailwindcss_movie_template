        ...
        <nav className="z-10 bg-white border-gray-200 px-2 sm:px-4 py-2.5 sticky top-0 dark:bg-gray-900">
            <div className="container flex flex-wrap items-center justify-around mx-auto">
                <a href="/" className="flex items-center">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">WOOKIE <br></br> MOVIES</span>
                </a>
                <div className="flex md:order-2">
                    ...
                    <div className="relative hidden md:block">
                        ...
                        <form method="post" className="flex items-center w-full max-w-sm space-x-2.5"
                            onSubmit={(e) => {
                                e.preventDefault();
                                const search = document.getElementById('search-navbar') as HTMLInputElement;
                                window.location.href = `/search/${search.value}`;
                            }}
                        >
                            <input type="text" id="search-navbar" className="block w-full py-2 px-12 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search movie..." />
